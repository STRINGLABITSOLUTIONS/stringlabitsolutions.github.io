    ...
    <div className="relative py-16">
        <div className="container relative m-auto px-6 text-gray-500 md:px-12 xl:px-40">
            <div className="m-auto space-y-8 md:w-8/12 lg:w-6/12 xl:w-6/12">
                <div className='flex'>
                    <img src={Logo} loading="lazy" className="ml-4 w-20 rounded-3xl" alt="string-lab logo" />
                ...
                <div className="p-8 py-12 sm:p-16">
                    ...
                    <p className="border-t border-gray-100 dark:border-gray-700 pt-6 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <NavLink to="#" className="text-primary">Sign up</NavLink>
                    </p>
                    </form>
                </div>
                </div>
                ...
                <NavLink to="#" className="text-sm hover:text-primary">Contact</NavLink>
                <NavLink to="#" className="text-sm hover:text-primary">Privacy & Terms</NavLink>
                </div>
            </div>
        </div>
    </div>  
