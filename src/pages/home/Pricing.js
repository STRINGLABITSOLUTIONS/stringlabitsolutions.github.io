...
export default function Pricing() {
  const icon1 =
    'https://tailus.io/sources/blocks/team/preview/images/tanzanite.webp';
  const icon2 =
    ...
    <section
      ...
      <div className='m-auto mt-12 items-center justify-center space-y-6 lg:flex lg:space-y-0 lg:space-x-6 xl:w-10/12'>
        <div className='group relative mx-auto sm:w-7/12 lg:w-4/12'>
          <div
            aria-hidden='true'
            className='absolute top-0 h-full w-full rounded-3xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-2xl shadow-gray-600/10 dark:shadow-none transition duration-300 group-hover:scale-105 lg:group-hover:scale-110'></div>
          <div className='relative space-y-8 p-8'>
            ...
            <p className='text-center text-gray-600 dark:text-gray-300'>
              If you only require access for one developer, this may be the plan
              for you.
            </p>
        ...
        <div className='group relative m-auto md:w-10/12 lg:w-8/12'>
          <div
            aria-hidden='true'
            className='absolute top-0 h-full w-full rounded-3xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-2xl shadow-gray-600/10 dark:shadow-none transition duration-300 group-hover:scale-105 hover:z-50 lg:group-hover:scale-110'></div>
          <div className='relative sm:flex'>
            <div className='space-y-8 p-8 pb-20 sm:w-7/12 sm:pb-8'>
              ...
              />
              <p className='text-center text-gray-600 dark:text-gray-300'>
                Wire your account to support 5 developers with a year's worth of
                unlimited access to tailus blocks!
              </p>
                  ...
                  <ul className='flex h-full w-max justify-center space-x-2 px-6 sm:w-full sm:flex-col sm:space-x-0 sm:space-y-6 sm:px-8'>
                    <li>
                      <div className='relative'>
                        ...
                        <div
                          aria-hidden='true'
                          className='absolute inset-x-0 top-[-2.20rem] z-[1] mx-auto h-6 w-6 scale-0 rounded-full border-8 border-white dark:border-gray-800 bg-primary transition peer-checked:scale-100 sm:inset-y-0 sm:left-[-2.70rem] sm:my-auto sm:ml-0'></div>
                      </div>
                    </li>
                    <li>
                      <div className='relative'>
