            ...
            <ul>
                <li className='flex items-center justify-between mt-3 py-2 px-2 bg-gray-500 rounded-lg'>
                    <img
                        ...
                        alt="bg" 
                    />
                    <h1 className='text-left'>BONIK - Inventory Management System: Model Pharmecy</h1>
                </li>
                <li className='flex items-center justify-between mt-3 py-2 px-2 bg-gray-500 rounded-lg'>
                    <img
                        className='w-24 h-14 rounded-lg object-cover' 
                        ...
                        alt="bg" 
                    />
                    <h1 className='text-left'>BHUJON - Restaurant Management System: Offline Services</h1>
                </li>
            </ul>
        </div>
    </div>
