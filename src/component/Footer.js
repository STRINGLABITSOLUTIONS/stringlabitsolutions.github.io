  ...
  return (
    <footer class="w-full bg-gray-100 dark:bg-gray-900 py-16">
        <div class="md:px-12 lg:px-28">
            ...
            <img src={logo} alt="logo tailus" class="m-auto w-12 h-12 rounded-full" />
            <ul
                role="list"
            ...
            <div class="text-center">
                <span class="text-sm tracking-wide">Copyright © String Lab <span id="year"></span> | All right reserved</span>
            </div>
            </div>
        </div>
    </footer>
