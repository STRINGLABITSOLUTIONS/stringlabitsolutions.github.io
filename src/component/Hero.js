...
export default function hero() {
  const bg =
    'https://officesnapshots.com/wp-content/uploads/2012/06/cheil06-700x344.jpg';
  const icon1 =
    'https://tailus.io/sources/blocks/job-board/preview/images/clients/microsoft.png';
  const icon2 =
    'https://tailus.io/sources/blocks/job-board/preview/images/clients/grabyo.png';
  const icon3 =
    'https://tailus.io/sources/blocks/job-board/preview/images/clients/lifegroups.png';
  const icon4 =
    'https://tailus.io/sources/blocks/job-board/preview/images/clients/lilly.png';
  const icon5 =
    'https://tailus.io/sources/blocks/job-board/preview/images/clients/grabyo.png';
  return (
    <div id='home' className='h-screen overflow-hidden'>
      <div className='relative'>
        ...
        <div
          aria-hidden='true'
          className='absolute inset-0 w-screen h-screen bg-purple-900 bg-opacity-30 backdrop-blur-lg'></div>
              ...
              <div className='relative flex p-1 rounded-xl bg-white shadow-2xl md:p-2'>
                <div
                  ...
                  <input
                    ...
                    name=''
                    id='toggleJobLstCat'
                    className='peer hidden outline-none'></input>
                  <input
                    type='text'
                    name=''
                    id='catJobName'
                  ...
                  <div
                    id='catJobLst'
                    className='absolute transition-all duration-200 ease-in-out translate-y-5 opacity-0 invisible peer-checked:opacity-100 peer-checked:visible peer-checked:translate-y-1 top-full left-0 w-full bg-white bg-opacity-80 rounded-lg py-2'>
