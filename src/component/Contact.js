      ...
      <div class="relative xl:container m-auto px-6 text-gray-500 md:px-12">
        <div class="m-auto space-y-8 sm:w-4/5 md:w-3/5 xl:w-2/5">
          <div class="p-8 md:py-12">
            <h2 class="mt-20 mb-8 text-3xl font-bold text-gray-800 dark:text-white">Feel Free to connect String Lab.</h2>
            <form action="" class="space-y-8">
              ...
              <p class="border-b border-gray-100 dark:border-gray-700text-gray-500 text-sm pb-6">By proceeding, you consent to get calls, WhatsApp or SMS messages, including by automated means, from Tailus and its affiliates to the number provided.</p>
            </form>
          </div>
        </div>
      </div>
